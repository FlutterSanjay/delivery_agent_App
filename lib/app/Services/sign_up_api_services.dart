...
import '../data/model/signup_request_model.dart'; // Still good to have the model structure

class AuthService extends GetxService {
  // Simulate a network delay
  Future<SignUpResponse> signUp(SignUpRequest request) async {
    print('Simulating signup for: ${request.username}, ${request.email}');
    ...
    if (request.email == 'test@example.com' && request.password == 'password123') {
      ...
      return SignUpResponse(
        message: 'Account created successfully for ${request.username}!',
